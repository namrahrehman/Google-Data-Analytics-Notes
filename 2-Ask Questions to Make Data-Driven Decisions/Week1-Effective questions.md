...
**Cloud:** A network of remote servers that store data online, accessible from anywhere with an internet connection, instead of a physical computer hard drive.

**Data analysis process:** The six-phased approach (ask, prepare, process, analyze, share, and act) to gain insights from data that drive informed decision-making.

**Data life cycle:** The sequence of stages data goes through, typically including planning, capturing, managing, analyzing, archiving, and destroying data.

**Leading question:** A question phrased in a way that steers people towards a specific answer.

**Measurable question:** A question whose answers can be quantified and evaluated using numbers or other measurable criteria.

**Problem types:** The various categories of problems data analysts encounter, such as categorizing data, discovering relationships between data points, finding patterns, identifying themes within data, making predictions based on data, and spotting unusual trends or outliers.

**Relevant question:** A question that directly relates to the specific problem you are trying to solve using data analysis.

**SMART methodology:** A framework used to assess the effectiveness of a question based on five criteria: Specific, Measurable, Action-oriented, Relevant, and Time-bound.

**Specific question:** A question that is clear, concise, and focused on a single topic or a small set of related ideas.

**Structured thinking:** A problem-solving approach that involves recognizing the current situation, organizing available information, identifying gaps and opportunities, and exploring potential solutions.

**Time-bound question:** A question that specifies a timeframe for the data or situation being analyzed.

**Unfair question:** A question phrased in a way that makes assumptions or is difficult to answer honestly due to its wording or context.
